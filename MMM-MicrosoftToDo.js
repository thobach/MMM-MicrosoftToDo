Module.register("MMM-MicrosoftToDo",{
    ...
    getDom: function() {
    	...
    	console.log('MMM-MicrosoftToDo: getDom');

      // decide if a checkbox icon should be shown in front of each tood list item
		  ...
		  if (this.readyState == 4 && this.status == 200) {
			...
			xhttp.onreadystatechange = function() {
			  ...
			  if (this.readyState == 4 && this.status == 200) {
				...
				list.value.forEach(element => listText += "<li style=\"list-style-type:none\">" + checkbox + element.subject + "</li>");
				listText += "</ul>";
    ...
    start: function() {
    	...
    	console.log('MMM-MicrosoftToDo: start');
