...
modules: [
  {
    ...
    config: {
      ...
      dynamicList: 'important', //optional parameter: currently only the list "important" is supported. If not specified displays tasks from default "Tasks" list, (if this is set it will ignore "listName" & "listId").
