# MMM-MicrosoftToDo 
MMM-MicrosoftToDo is a 3rd party module for [MagicMirror](https://github.com/MichMich/MagicMirror) that shows open tasks from task lists. The tasks are retrieved from the Microsoft To Do / Outlook.
...
# Select as "Platform configuration": "Client Application"
# Click "Register"
# Go to "Overview" and copy the "Application ID" (Client ID), e.g. "4ef19f40-4892-4905-b999-76041e991f53"

Generate a client secret key
# Go to "Authentication"
# Click on "Add a platform"
# Select "Web app"
# Set as "Redirect URI": "https://localhost:1234"
# Click "Configure"
# Go to "Certificates & secrets"
# Click "+ New client secret"
# Set as "Description": "Magic Mirror"
# Select as "Expires": "Never"
# Copy the "Value", e.g. "1Q25ls?TKEDf4RWBKVUbKjnaVu=ytP.[", it will be the client secret you need later
...
# Click on "Yes" and wait to be redirected
# Copy "code" parameter from the URL in the browser, e.g. "M30cd0dff-af91-d061-8755-ffb3b328aa03" from https://localhost:1234/?code=M30cd0dff-af91-d061-8755-ffb3b328aa03&state=12345

Generate refresh and access token
# Open Terminal app
# Run the following command with your "client_id", "code" and "client_secret" parameters
curl -X POST \
...
# Go to https://to-do.microsoft.com/tasks/?fromOwa=true
# Select your desired task list
# Copy the task list ID from the URL, e.g. "AQMkADAwATNiZmYAZC1iODgANS1hNGMyLTAwAi0wMAoALgAAA1Lh_i4gMGJMlZDpJ2d8iWwBAB_qpxIEaN5AgOOJ-T1mRJ8AAzJQqfYAAAA=" from "https://to-do.microsoft.com/tasks/AQMkADAwATNiZmYAZC1iODgANS1hNGMyLTAwAi0wMAoALgAAA1Lh_i4gMGJMlZDpJ2d8iWwBAB_qpxIEaN5AgOOJ-T1mRJ8AAzJQqfYAAAA="
